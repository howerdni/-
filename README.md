...
![image](https://github.com/howerdni/Suzhou-PowerGrid-Simulation/blob/main/1739366112112.jpg)
---

以上为DIGSILENT搭建的LCC直流输电的一个极的一个12脉动，国内目前常见的形式是双极双12脉动阀组接线，白鹤滩的受端一极由1个12脉动LCC和3个并联的VSC组成，其中一个12脉动可以用上述模型仿真。
